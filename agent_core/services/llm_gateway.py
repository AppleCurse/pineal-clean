...
class LLMGateway:
    MODEL_REGISTRY = {
        ...
        # teyitli free modeller. gpt-oss-120b: groq (tam) + cerebras (suffix)
        # direct free; laguna :free: nous direct free (canlı prefix'li yazım).
    ...
    AGENT_CHAINS = {
        ...
        "human_behavior": [MODEL_REGISTRY["claude_sonnet_5"], MODEL_REGISTRY["deepseek_v4_pro"]],
